  ...
  return (
    <div className="shell">
      <aside className="sidebar">
        ...
        <div className={`nav-item ${section === 'governance' ? 'active' : ''}`} onClick={() => navigate('/governance')}>
          <span className="ico">◈</span> Governance
        </div>
      ...
      <main className="main">
        ...
        {section === 'governance' && <Governance navigate={navigate} />}
