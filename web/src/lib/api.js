...
export const api = {
  ...
  continueRun: (runId, body) => call(`/runs/${runId}/continue`, { method: 'POST', body }),
  rerunRun: (runId, body) => call(`/runs/${runId}/rerun`, { method: 'POST', body }),
  ...
  bmad: (reload = false) => call(`/personas${reload ? '?reload=1' : ''}`),
